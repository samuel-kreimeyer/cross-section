# Issue: Type Error: "object" has no attribute "exterior"  [attr-define...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116132Z

## Summary
Type error detected by mypy on line 52.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:52: error: "object" has no attribute "exterior"  [attr-defined]
```
