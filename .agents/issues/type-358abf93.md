...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116109Z

## Summary
Type error detected by mypy on line 131.
...
mypy output:
```
src/cross_section/core/domain/components/curbs.py:131: error: Item "None" of "ConcreteLayer | None" has no attribute "compressive_strength"  [union-attr]
```
