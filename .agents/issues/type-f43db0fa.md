...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116176Z

## Summary
Type error detected by mypy on line 154.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:154: error: "object" has no attribute "geoms"  [attr-defined]
```
