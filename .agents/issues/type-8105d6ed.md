# Issue: Type Error: Library stubs not installed for "shapely.validatio...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116129Z

## Summary
Type error detected by mypy on line 26.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:26: error: Library stubs not installed for "shapely.validation"  [import-untyped]
```
