...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-24T20:23:19.029528Z

## Summary
Type error detected by mypy on line 123.
...
mypy output:
```
src/cross_section/core/domain/annotations/planner.py:123: error: Function is missing a type annotation for one or more arguments  [no-untyped-def]
```
