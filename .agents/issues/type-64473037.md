# Issue: Type Error: Unsupported operand types for / ("None" and "float...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116070Z
...
mypy output:
```
src/cross_section/core/domain/components/slopes.py:143: error: Unsupported operand types for / ("None" and "float")  [operator]
```
