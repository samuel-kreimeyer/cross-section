...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116192Z

## Summary
Type error detected by mypy on line 285.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:285: error: "object" not callable  [operator]
```
