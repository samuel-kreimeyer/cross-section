# Issue: Type Error: "object" has no attribute "distance"  [attr-define...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116204Z
...
mypy output:
```
src/cross_section/core/geometry/validate.py:347: error: "object" has no attribute "distance"  [attr-defined]
```
