...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116170Z

## Summary
Type error detected by mypy on line 149.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:149: error: "object" has no attribute "geoms"  [attr-defined]
```
