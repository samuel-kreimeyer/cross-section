# Issue: Type Error: Library stubs not installed for "shapely.geometry"...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116112Z
...
mypy output:
```
src/cross_section/core/geometry/validate.py:24: error: Library stubs not installed for "shapely.geometry"  [import-untyped]
```
