...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-24T20:23:19.029496Z

## Summary
Type error detected by mypy on line 63.
...
mypy output:
```
src/cross_section/core/domain/annotations/text.py:63: error: Incompatible types in assignment (expression has type "float", variable has type "int")  [assignment]
```
