...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116195Z

## Summary
Type error detected by mypy on line 316.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:316: error: "object" not callable  [operator]
```
