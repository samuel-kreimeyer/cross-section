# Issue: Type Error: "object" has no attribute "touches"  [attr-defined...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116217Z
...
mypy output:
```
src/cross_section/core/geometry/validate.py:370: error: "object" has no attribute "touches"  [attr-defined]
```
