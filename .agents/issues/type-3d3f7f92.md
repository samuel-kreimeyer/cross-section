# Issue: Type Error: "object" has no attribute "intersection"  [attr-de...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116182Z

## Summary
Type error detected by mypy on line 176.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:176: error: "object" has no attribute "intersection"  [attr-defined]
```
