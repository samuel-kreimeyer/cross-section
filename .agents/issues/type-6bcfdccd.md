...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116164Z

## Summary
Type error detected by mypy on line 144.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:144: error: "object" has no attribute "geom_type"  [attr-defined]
```
