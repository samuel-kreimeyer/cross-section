# Issue: Type Error: "object" has no attribute "intersects"  [attr-defi...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116213Z

## Summary
Type error detected by mypy on line 370.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:370: error: "object" has no attribute "intersects"  [attr-defined]
```
