# Issue: Type Error: "object" has no attribute "interiors"  [attr-defin...

**Type:** type
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116135Z

## Summary
Type error detected by mypy on line 55.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:55: error: "object" has no attribute "interiors"  [attr-defined]
```
