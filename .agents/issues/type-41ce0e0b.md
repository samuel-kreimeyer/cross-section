...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116098Z

## Summary
Type error detected by mypy on line 173.
...
mypy output:
```
src/cross_section/core/domain/components/slopes.py:173: error: Argument 1 to "abs" has incompatible type "float | None"; expected "SupportsAbs[float]"  [arg-type]
```
