...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116161Z

## Summary
Type error detected by mypy on line 141.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:141: error: "object" has no attribute "is_empty"  [attr-defined]
```
