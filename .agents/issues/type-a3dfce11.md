...
**Severity:** error
**Tool:** check-types
**Detected:** 2026-01-10T16:23:09.116198Z

## Summary
Type error detected by mypy on line 325.
...
mypy output:
```
src/cross_section/core/geometry/validate.py:325: error: "object" has no attribute "intersects"  [attr-defined]
```
