...
- [x] Configure development tools (black, mypy, pytest, ruff)
...
- [x] Implement `ComponentGeometry` class
- [x] Implement `SectionGeometry` class
- [ ] Create geometry transformation utilities
- [x] Write geometry tests
...
- [ ] Implement `to_geometry()` for each component type:
  - [x] Lane geometry (rectangular with cross-slope)
  - [x] Shoulder geometry
  - [x] Curb geometry (with vertical face)
  - [ ] Median geometry
  - [x] Slope geometry (triangular/trapezoidal)
- [x] Implement positioning algorithm
- [x] Handle elevation changes
...
- [x] Implement left-to-right component placement
- [x] Handle connection points between components
- [x] Implement elevation matching
...
- [ ] `TurnLane` component
- [ ] `Gutter` component
- [x] `Barrier` component (concrete, cable, etc.)
- [x] `Ditch` component
